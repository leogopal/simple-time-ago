...
Installing "Simple Time Ago" can be done either by searching for "Simple Time Ago" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
